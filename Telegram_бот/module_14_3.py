...
kb_in_buy = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(text='Орехи', callback_data='product_buying'),
            InlineKeyboardButton(text='Мясо', callback_data='product_buying'),
            InlineKeyboardButton(text='Зелень', callback_data='product_buying'),
            InlineKeyboardButton(text='Сухофрукты', callback_data='product_buying'),
...
async def get_buying_list(message):
    name_product = ['Орехи', 'Мясо', 'Зелень', 'Сухофрукты']
    for i in range(1, 5):
        with open(f'imgs/Product{i}.jpg', 'rb') as img:
            await message.answer_photo(img,
                                       f'Название: {name_product[i - 1]} | Описание: описание {i} | Цена: {i * 100}')
